...
export const Card = ({ rotate, scale, children }) => {
  return (
    <motion.div
      ...
      className="max-w-5xl mx-auto min-h-[30rem] sm:min-h-[34rem] md:min-h-[38rem] w-full border-2 sm:border-4 border-[#23283B] p-2 sm:p-4 md:p-6 bg-[#141724] rounded-[24px] sm:rounded-[32px] shadow-2xl shadow-nm-orange/20 relative group hover:border-nm-orange/50 transition-colors flex flex-col will-change-transform transform-gpu"
    >
